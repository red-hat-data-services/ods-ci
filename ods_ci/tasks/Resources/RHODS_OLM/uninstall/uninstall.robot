...
Uninstall RHODS In OSD
  ...
  ...    cd ${EXECDIR}/${OLM_DIR} &&  git switch operators-cleanup &&./cleanup.sh -t addon -a "authorino serverless servicemesh servicemesh3 clusterobservability tempo opentelemetry kueue certmanager cma connectivitylink leaderworkerset"
  ...    timeout=20 min
