...
<<<<<<< HEAD
  ...    cd ${EXECDIR}/${OLM_DIR} && ./cleanup.sh -t addon -a "authorino serverless servicemesh clusterobservability tempo opentelemetry kueue certmanager cma jobset connectivitylink"
=======
  ...    cd ${EXECDIR}/${OLM_DIR} && ./cleanup.sh -t addon -a "authorino serverless servicemesh servicemesh3 clusterobservability tempo opentelemetry kueue certmanager cma connectivitylink leaderworkerset"
>>>>>>> fc292547 (add: include leaderworkerset and servicemesh3 operators in cleanup)
  ...    timeout=20 min
