...
${FEASTOPERATOR_CONTROLLER_MANAGER_DEPLOYMENT_NAME}   feastoperator-service-operator-controller-manager
...
Validate Feastoperator Managed State
    ...
    [Tags]    Operator    Tier1    feastoperator-managed      Integration
...
Validate Feastoperator Removed State
    ...
    [Tags]    Operator    Tier1     feastoperator-removed     Integration
