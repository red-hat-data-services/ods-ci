...
Verify Custom Application Resource Creation
    [Documentation]     Create Custom Resource Application by using Dashboard CRDs: OdhApplication.
    ...
    ...                                                     expected_titles=${exp_titles}
    Run Keyword And Continue On Failure     External Link Should Be
    ...    expected_url=${DASH_EXPLORE_EXP_DATA["custom-odsci-app"]["sidebar_links"]["0"]["url"]}
...
Verify Custom "How-To" Resource Creation
    [Documentation]     Create a Custom Resource "HowTo" by using Dashboard CRDs: OdhDocument,
    ...                 and verify appearance in Dashboard.
    ...                 ProductBug: RHOAIENG-5317
    [Tags]    Sanity
    ...       ODS-1769
...
Verify Custom "Tutorial" Resource Creation
    [Documentation]     Create a Custom Resource "Tutorial" by using Dashboard CRDs: OdhDocument,
    ...                 and verify appearance in Dashboard.
    ...                 ProductBug: RHOAIENG-5317
    [Tags]    Tier1
    ...       ODS-1770
