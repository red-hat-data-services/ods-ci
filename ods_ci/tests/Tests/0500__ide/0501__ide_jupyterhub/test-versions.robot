...
Verify Libraries in PyTorch Image
    ...
    Verify List Of Libraries In Image    pytorch    JupyterLab ${JupyterLab_Version}    JupyterLab-git ${JupyterLab-git_Version}
...
Verify Libraries in Tensorflow Image
    ...
    Verify List Of Libraries In Image    tensorflow    JupyterLab ${JupyterLab_Version}    JupyterLab-git ${JupyterLab-git_Version}
