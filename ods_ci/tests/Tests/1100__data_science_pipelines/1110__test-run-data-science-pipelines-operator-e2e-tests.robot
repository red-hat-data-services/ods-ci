...
${DATA-SCIENCE-PIPELINES-OPERATOR-SDK_REPO_URL}           https://github.com/diegolovison/data-science-pipelines-operator.git
${DATA-SCIENCE-PIPELINES-OPERATOR-SDK_REPO_BRANCH}        "10212-4"
