...
Wait Until JupyterHub Spawner Is Ready
    ...
    IF    ${version-check}==True
        ...
        ...    xpath://div[contains(concat(' ',normalize-space(@class),' '),' jsp-spawner__size_options__select ')]
    ELSE
...
Has Spawn Failed
    ...
    ELSE
        ${spawn_status} =    Run Keyword and Return Status    Page Should Contain Element
        ...    xpath://p[starts-with(., "Spawn failed")]
    END
    [Return]    ${spawn_status}
    ...
    FOR    ${index}    IN RANGE    0    1+${retries}
        ...
        IF    ${spawner_ready}==True
         ...
         END
            ...
            END
            Spawn Notebook
            Run Keyword And Continue On Failure    Wait Until Page Does Not Contain Element    id:progress-bar
            ...    ${spawner_timeout}
