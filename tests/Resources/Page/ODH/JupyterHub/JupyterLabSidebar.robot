...
Get Install Plugin list from JupyterLab
    ...
    Run Keyword And Return Status    Wait Until Page Contains Element
    ...    xpath://*[@class="jp-extensionmanager-disclaimer"]//*[contains(text(), "Enable")]    timeout=10
    Run Keyword And Return Status    Click Button    Enable
    Run Keyword And Return Status    Wait Until Page Contains Element
    ...    xpath://*[@class="jp-extensionmanager-disclaimer"]//*[contains(text(), "Disable")]    timeout=10
    ${link_elements}=    Get WebElements
    ...    xpath://ul[@class="jp-extensionmanager-listview"]//li[contains(@class,"jp-extensionmanager-entry-ok")]//a
