...
Verify Dashboard Deployment
    ...
    Verify Deployment  ${dashboard}  2  2  ${containerNames}  status=True
...
Verify Traefik Deployment
    ...
    Verify Deployment  ${traefik}  3  2  ${containerNames}  status=True
...
Verify JH Deployment
    ...
    Verify Deployment  ${JH}  3  2  ${containerNames}  status=False