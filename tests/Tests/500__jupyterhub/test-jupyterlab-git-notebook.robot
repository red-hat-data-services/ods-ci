...
Can Launch Python3 Smoke Test Notebook
    ...
    ...    https://github.com/sophwats/notebook-smoke-test
    Click Element    xpath://div[.="CLONE"]

    Open With JupyterLab Menu    File    Open from Path…
    Input Text    //div[.="Open Path"]/../div[contains(@class, "jp-Dialog-body")]//input
    ...    notebook-smoke-test/watermark-smoke-test.ipynb
