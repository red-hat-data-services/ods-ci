...
Can Spawn Notebook
    ...
    Fix Spawner Status
    &{S3-credentials} =    Create Dictionary    AWS_ACCESS_KEY_ID=${S3.AWS_ACCESS_KEY_ID}
...
Can Launch Python3 Smoke Test Notebook
    ...
    ...    https://github.com/lugi0/clustering-notebook
    Click Element    xpath://div[.="CLONE"]
    Sleep    10
    Open With JupyterLab Menu    File    Open from Path…
    Input Text    xpath=//input[@placeholder="/path/relative/to/jlab/root"]
    ...    clustering-notebook/CCFraud-clustering-S3.ipynb
